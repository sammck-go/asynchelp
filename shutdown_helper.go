...
// OnceActivateCallback is a function that is called exactly once with shutdown paused
...
//           returns an error
//        returns nil
func (h *ShutdownHelper) DoOnceActivate(OnceActivateCallback OnceActivateCallback, waitOnFail bool) error {
	var err error
	h.Lock.Lock()
	if h.isActivated {
		h.Lock.Unlock()
